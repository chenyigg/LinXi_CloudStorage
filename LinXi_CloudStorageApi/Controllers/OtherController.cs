...
namespace LinXi_CloudStorageApi.Controllers
{
    ...
    public class OtherController : ControllerBase
    {
        ...
        private ILogger<OtherController> _logger;
        ...
        {
            //查询出所有符合条件的资源
            List<LxResourceAccount> FileList = (await _ILxResourceAccountService.Search(u => u.LxUsersId == UserId && u.LxRecycle == false && u.LxResource.LxResourceCategoryId == 8 && EF.Functions.Like(u.LxResourceAccountName, $"%{SearchName}%"))).ToList();
